...
def foodHeuristic(state, problem):
    ...
    # If no food, then return 0. As no possible solution.
    if len(food) == 0:
        return 0
    
    # The given maze-distance function to determine the heuristic.
    # This heuristic is consistent.
    # The maze distance will always find the same distance to a given piece of food.
    # Heursitic will also return 0 at a goal (since if pacman eats all of 
